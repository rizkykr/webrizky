window.onload = function () {
  ...
  messages.en = [
    ...
    'I\'m currently accepting freelance work.<br> You can contact me at <a href="mailto:me@rizkykr.com">me@rizkykr.com</a>',
    '<a target="_blank" href="https://codepen.io/rizkykurniawanritonga">codepen.io/rizkykurniawanritonga</a><br><a target="_blank" href="https://github.com/rizkykurniawanritonga">github.com/rizkykurniawanritonga</a>',
    getCurrentTime(),
    "👀 R.",
  ];
  ...
  var sendMessages = function () {
    var ploc = loca == "ID" ? "id" : "en";
    var message = messages[ploc][messageIndex];
    if (!message) return;
    sendMessage(message);
    ++messageIndex;
    setTimeout(
