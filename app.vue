<template>
  ...
  <div class="outeerapp flex flex-col fixed top-0 h-full w-screen">
    ...
    <LazyDialogSosmed :lang='lang' :show="showDialog" :sosmed="sosmed" :lokasi="lokasi" @tutup="showDialog = false"/>
  </div>
</template>
<script>
