<template>
  <span
    class="relative animate__animated animate__faster rounded-full last-of-type:rounded-bl-none transition-all bg-white dark:bg-slate-800 text-slate-900 dark:text-white ring-1 ring-slate-900/5 shadow w-fit !leading-5 mb-2 md:mx-4 mx-3 first:mt-4 last:mb-4 md:text-base text-sm antialiased font-sans"
    :class="
      type == 'loading'
